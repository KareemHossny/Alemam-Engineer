    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-800">View Monthly Tasks</h1>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg border border-gray-200/50 p-6 mb-8">
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <div className="flex-1 max-w-xs">
            ...
            <div className="relative group">
              <input
                ...
                className="w-full px-4 py-3 pl-12 border-2 border-gray-200 rounded-2xl transition-all duration-300 bg-white text-gray-800 group-hover:border-orange-300 shadow-sm focus:border-orange-500 focus:ring-0 focus:outline-none"
              />
          ...
          <div className="text-sm text-gray-600">
            Showing {tasks.length} task(s) for {selectedMonth}
          </div>
        </div>
      </div>
